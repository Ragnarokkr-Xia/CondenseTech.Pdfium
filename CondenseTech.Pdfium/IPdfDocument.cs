...
namespace CondenseTech.Pdfium
{
    ...
    public interface IPdfDocument : IDisposable
    {
        ...
        SKImage Render(int page, float dpiX, float dpiY, bool forPrinting);
        ...
        /// <returns>The rendered image.</returns>
        SKImage Render(int page, float dpiX, float dpiY, PdfRenderFlags flags);
        ...
        /// <param name="forPrinting">Render the page for printing.</param>
        /// <returns>The rendered image.</returns>
        SKImage Render(int page, int width, int height, float dpiX, float dpiY, bool forPrinting);
        ...
        /// <param name="flags">Flags used to influence the rendering.</param>
        /// <returns>The rendered image.</returns>
        SKImage Render(int page, int width, int height, float dpiX, float dpiY, PdfRenderFlags flags);
        ...
        /// <param name="flags">Flags used to influence the rendering.</param>
        /// <returns>The rendered image.</returns>
        SKImage Render(int page, int width, int height, float dpiX, float dpiY, PdfRotation rotate, PdfRenderFlags flags);
        ...
        PdfPageLinks GetPageLinks(int page, SKSizeI size);
        ...
        SKPoint PointToPdf(int page, SKPointI point);
        ...
        /// <param name="point">The point to convert.</param>
        /// <returns>The converted point.</returns>
        SKPointI PointFromPdf(int page, SKPoint point);
        ...
        SKRect RectangleToPdf(int page, SKRectI rect);
        ...
        /// <param name="rect">The rectangle to convert.</param>
        /// <returns>The converted rectangle.</returns>
        SKRectI RectangleFromPdf(int page, SKRect rect);
    }
}
